      ...
      <div className="home-content">
        ...
        <div className="testimonials-section">
          ...
          <div className="testimonials-grid">
            {[
              { name: "Foxy & Rosie", img: "/images/couple1.jpg", story: "Met during the spring festival, now happily raising 3 chicks! 🐣" },
              { name: "Cluckster & Bella", img: "/images/couple2.jpg", story: "A monsoon romance that turned into lifelong love 🌧❤️" },
              { name: "Amber & Rusty", img: "/images/couple3.jpg", story: "Bonded over corn trading and evening walks 🌽✨" },
            ].map((t, i) => (
        ...
        <div className="promotions-section">
          ...
          <div className="promotion-banner">
            🌞 Sunny Season Match Boost: Double your profile visibility for 24 hrs.
          </div>
        </div>
          ...
          <div className="profile-modal-content">
            ...
            <div className="profile-image-container">
              {user.profileImage ? (
                ...
                <div className="profile-letter-big">{user.name.charAt(0).toUpperCase()}</div>
              )}
              ...
              <div className="profile-info">
                ...
                <div className="profile-stats">
                  <div className="stat-item"><span className="stat-label">Height:</span><span className="stat-value">{user.heightCm} cm</span></div>
                  <div className="stat-item"><span className="stat-label">Weight:</span><span className="stat-value">{user.weightKg} kg</span></div>
                  <div className="stat-item"><span className="stat-label">Income:</span><span className="stat-value">{user.incomePerMonthCorn} corn/month 🌽</span></div>
                  <div className="stat-item"><span className="stat-label">Compatibility:</span><span className="stat-value">{user.compatibilityScore}% 💯</span></div>
                </div>
              </div>
            </div>

            <div className="info-cards">
              <div className="info-card"><h3>🎓 Professional Info</h3>
                <p><strong>Education:</strong> {user.education}</p>
                <p><strong>Qualification:</strong> {user.qualification}</p>
                <p><strong>Job Title:</strong> {user.jobTitle}</p>
                <p><strong>Color:</strong> {user.furColor || user.featherColor}</p>
              </div>
              <div className="info-card"><h3>🏠 Family Background</h3>
              ...
              <div className="info-card"><h3>🎯 Preferences</h3>
              ...
              <div className="info-card hobbies-card"><h3>🎨 My Hobbies</h3>
