      ...
      <div className="pickup-content">
        <div className="pickup-header">
          ...
          <p className="pickup-subtitle">
            Get the perfect lines to woo your {user.lookingFor.toLowerCase()}s! {user.type === 'fox' ? '🦊' : '🐓'}
          </p>
        </div>
        ...
        <div className="pickup-main">
          <div className="pickup-generator">
            <div className="generator-card">
              <div className="generator-header">
                <h2>✨ {user.type === 'fox' ? 'Foxy' : 'Clucky'} Pickup Line Generator</h2>
                <p>Perfect lines for {user.type === 'fox' ? 'charming chickens' : 'impressing foxes'}!</p>
              </div>
                ...
                {currentLine ? (
                  ...
                  <div className="no-line">
                    <div className="line-placeholder">
                      {user.type === 'fox' ? '🦊' : '🐓'} Click the button below to get your perfect pickup line!
                    </div>
                  </div>
                )}
              </div>
          ...
          <div className="pickup-tips">
            <div className="tips-card">
              <h3>💡 Pro Tips for {user.type === 'fox' ? 'Foxes' : 'Chickens'}</h3>
              <div className="tips-list">
                {user.type === 'fox' ? (
                  <>
                    <div className="tip-item">
                      <span className="tip-icon">🎯</span>
                      <span>Be confident but respectful - chickens love a gentleman fox!</span>
                    </div>
                    <div className="tip-item">
                      <span className="tip-icon">🌟</span>
                      <span>Show your softer side - not all foxes are sly!</span>
                    </div>
                    <div className="tip-item">
                      <span className="tip-icon">💬</span>
                      <span>Listen actively - chickens have great stories to share!</span>
                    </div>
                    <div className="tip-item">
                      <span className="tip-icon">🎭</span>
                      <span>Use humor wisely - a good laugh can break any ice!</span>
                    </div>
                  </>
                ) : (
                  <>
                    ...
                    <div className="tip-item">
                      <span className="tip-icon">💪</span>
                      <span>Show your brave side - confidence is attractive!</span>
                    </div>
                    <div className="tip-item">
                      <span className="tip-icon">🎶</span>
                      <span>Share your interests - common hobbies create bonds!</span>
                    </div>
                    <div className="tip-item">
                      <span className="tip-icon">💝</span>
                      <span>Be genuine with compliments - sincerity always wins!</span>
                    </div>
                  </>
                )}
              </div>
            ...
            <div className="weather-card">
              ...
              <div className="weather-info">
                ...
                <p>Remember: Foxes and chickens marry when it's both sunny and rainy!</p>
        ...
        <div className="pickup-stats">
          ...
          <div className="stat-card">
            ...
            <div className="stat-value">{Math.floor(Math.random() * 30) + 70}%</div>
          </div>
          <div className="stat-card">
            <div className="stat-number">💕</div>
            <div className="stat-label">Happy Couples</div>
            <div className="stat-value">{Math.floor(Math.random() * 100) + 200}</div>
          </div>
        </div>
      </div>
    </div>
